...
# Use data structure to store names and years of movie by using data frame for 
# more comfortable in names and years table.
# And to store vector for we can check length for easily.
