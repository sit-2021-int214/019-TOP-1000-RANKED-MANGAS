...
print('why you using this data structure ?')
print('easy for viewing and can be character,numeric')

print('The numbers of movies') 
length(names)

print('Finding the 19th movies name') 
names[19]

print('Which year is most released movies')
#print('2017, 2021')
