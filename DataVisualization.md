...
### ❓ Question: มังงะที่ได้รับความนิยม 10 อันดับแรก(Rank) สถานะการตีพิมพ์ปัจจุบันเป็นอย่างไร
``` ruby
Mangas %>% 
...
### ❓ Question: เปรียบเทียบแต่ละปีว่ามีการ์ตูนแนวไหนออกมาเยอะกว่ากัน โดยอิงไปถึงความชื่นชอบได้? จากข้อมูลย้อนหลัง 5 ปีที่แล้ว มังงะทั้ง 3 ประเภท ได้แก่ Action, Drama, Fantasy
``` ruby
Year_2016 <- Mangas %>% 
