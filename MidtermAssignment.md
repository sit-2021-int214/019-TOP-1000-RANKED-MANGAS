...
```
#### Result 
สามารถนำข้อมูลไปใช้ดูมังงะที่จบแล้วและมีความยอดนิยม(Popularity) สำหรับกลุ่มลูกค้าที่ต้องการอ่านเรื่องที่นิยมและจบแล้ว
```
โค้ดจงมาอยู่นี่
```
...
```
#### Result 
สามารถนำข้อมูลไปใช้ดูมังงะที่ตีพิมพ์จบแล้ว แต่ไม่จำนวนตอนไม่เยอะมากจนเกินไป สำหรับกลุ่มลูกค้าที่ต้องการหาเวลาว่างมานั่งอ่านมังงะสั้น ๆ สักเรื่อง
```
โค้ดจงมาอยู่นี่
```
...
```
#### Result 
สามารถนำข้อมูลความนิยมและเรื่องย่อ ไปใช้ประกอบเว็บไซต์แนะนำมังงะได้
```
โค้ดจงมาอยู่นี่
```
...
```
#### Result 
สามารถนำข้อมูลเปรียบเทียบระหว่างประเภท 'Action' กับ 'Fantasy' มาหาความนิยมในปัจจุบันว่ากลุ่มลูกค้าสนใจประเภทไหนมากกว่ากัน
```
โค้ดจงมาอยู่นี่
```
...
```
#### Result 
สามารถนำข้อมูลข้อมูลไปหาความนิยมของคนในยุคนั้นได้ว่าแนวทางอนิเมะที่ดูนั้นเป็นอย่างไร
```
โค้ดจงมาอยู่นี่
```
